...
// res11: JwtClaim = pdi.jwt.JwtClaim@f2e4a029
// Right now! (the token is directly invalid...)
claim.expiresNow
// res12: JwtClaim = pdi.jwt.JwtClaim@ed6cd471

// Set the beginning of the token (aka the "not before" attribute)
// 5 seconds ago
claim.startsIn(-5)
// res13: JwtClaim = pdi.jwt.JwtClaim@e56436eb
// At a specific timestamp (in seconds)
claim.startsAt(1431520421)
// res14: JwtClaim = pdi.jwt.JwtClaim@9f3f9831
// Right now!
...
// 5 seconds ago
claim.issuedIn(-5)
// res16: JwtClaim = pdi.jwt.JwtClaim@dc6adc00
// At a specific timestamp (in seconds)
claim.issuedAt(1431520421)
// res17: JwtClaim = pdi.jwt.JwtClaim@a89b39fa
// Right now!
...
claim.toJson
// res21: String = "{\"iss\":\"Me\",\"sub\":\"Something\",\"aud\":\"You\",\"exp\":1615750868,\"nbf\":1615750863,\"iat\":1615750863,\"jti\":\"42\",\"user\":1,\"key1\":\"value1\",\"key2\":true,\"key3\":3,\"key4\":[1,2],\"key5\":{\"key5.1\":\"Subkey\"}}"
```
